class Final_Project:
    ...
    def admin_register(self):
        try:
            ...
            print(f"Welcome TO {self.restro_name} Final_Project\n")
            print("Admin Details : ")
...
try:
    def main():
        obj=Final_Project("Gajanan Kabure")
        print(f"#"*36+"\n    Welcome To {obj.restoro_name}Edyoda Restaurant\n"+"#"*36+ \
        "\nPlease Chose your Order:")
        # print(f"!!  Welcome To {obj.restro_name} Final_Project  !!\n")
        # print("!!----------------------------------------------------------")
